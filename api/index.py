...
#
# Handles two request types via a mode query parameter:
#   GET /api/index?mode=ratios&ticker=TICKER.NS
#   GET /api/index?mode=prices&ticker=TICKER.NS&range=6mo
#
# Both fetch live from Yahoo Finance via yfinance -- nothing is cached
# or pre-generated, this runs fresh on every request.
